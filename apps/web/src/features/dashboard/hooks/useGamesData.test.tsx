...
vi.mock("../../../shared/api", () => ({
  ...
  listLeagues: vi.fn(async () => [{ league: "NBA", sport: "basketball", label: "NBA", badge_label: "NBA", alert_types: ["game_start", "close_game_late", "final_result"], live_sync_interval_seconds: 120, is_enabled: true }]),
}));
