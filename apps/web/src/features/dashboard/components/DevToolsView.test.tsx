...
const sendDevTestEmailMock = vi.fn(async ({ league, alert_type }: { league: "NBA" | "WNBA" | "MLB" | "MLS" | "WORLD_CUP"; alert_type: string }) => ({
  id: 1,
  game_id: 100,
  league,
  alert_type,
...
vi.mock("../../../shared/api", () => ({
  ...
  sendDevTestEmail: (_token: string, payload: { league: "NBA" | "WNBA" | "MLB" | "MLS" | "WORLD_CUP"; alert_type: string }) =>
