...
def test_ops_routes_return_data_for_admin(client, monkeypatch):
    ...
    assert league_settings.json()["items"] == [
        ...
        {"league": "WNBA", "sport": "basketball", "label": "WNBA", "badge_label": "WNBA", "alert_types": ["game_start", "close_game_late", "final_result"], "live_sync_interval_seconds": 120, "default_test_matchup": ["NY", "LV"], "is_enabled": True},
