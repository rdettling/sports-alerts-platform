...
def test_ops_routes_return_data_for_admin(client, monkeypatch):
    ...
    assert ingest_health.json()["active_leagues"] == ["NBA", "WNBA", "NFL", "MLB", "MLS", "WORLD_CUP"]
    ...
    assert league_settings.json()["items"] == [
        ...
        {"league": "WNBA", "sport": "basketball", "label": "WNBA", "badge_label": "WNBA", "alert_types": ["game_start", "close_game_late", "overtime_start", "final_result"], "live_sync_interval_seconds": 120, "default_test_matchup": ["NY", "LV"], "is_enabled": True},
        {"league": "NFL", "sport": "football", "label": "NFL", "badge_label": "NFL", "alert_types": ["game_start", "close_game_late", "overtime_start", "final_result"], "live_sync_interval_seconds": 120, "default_test_matchup": ["KC", "BUF"], "is_enabled": True},
        {"league": "MLB", "sport": "baseball", "label": "MLB", "badge_label": "MLB", "alert_types": ["game_start", "inning_start", "extra_innings_start", "final_result"], "live_sync_interval_seconds": 300, "default_test_matchup": ["MIA", "TOR"], "is_enabled": True},
                ...
                return _FakeResponse(
                    {
                        "events": [
                            {
                                "competitions": [
                                    {"competitors": [{"team": {"id": "9"}}, {"team": {"id": "17"}}]}
                                ]
                            }
                        ]
                    }
