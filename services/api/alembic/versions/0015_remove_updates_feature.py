"""remove updates feature tables

Revision ID: 0015_remove_updates_feature
Revises: 0014_widen_game_clock
...
revision: str = "0015_remove_updates_feature"
down_revision: Union[str, None] = "0014_widen_game_clock"
...
def upgrade() -> None:
    if _has_table("sports_update_teams"):
    ...
    if _has_table("sports_update_source_items"):
    ...
    if _has_table("user_league_follows"):
